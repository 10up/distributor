...
class WordPressBasicAuth extends Authentication {
	...
	public static function credentials_form( $args = array() ) {
		...
		<p>
			...
			<span class="description"><?php esc_html_e( 'We need a username (preferably with an Administrator role) for the WordPress site you are connecting to.', 'distributor' ); ?>
		</p>
...
<a class="change-password" href="#"><?php esc_html_e( '(Change)', 'distributor' ); ?></a><?php endif; ?></label><br>
			...
			<span class="description">
				...
				printf( __( '<strong>Important:</strong> We strongly recommend using the <a href="%s">Application Passwords</a> plugin on the site you are connecting to in order to create a unique password for this connection. This helps limit the use of your primary password and will allow you to revoke access in the future if needed.', 'distributor' ), esc_url( $plugin_link ) );
				?>
		</p>
		<?php
	}
