...
function distributable_post_statuses() {
	 ...
	 *
	 * @param array Post statuses that are distributable.
	 *
...
function prepare_taxonomy_terms( $post_id ) {
	 ...
	 * @param object $post        The Post Object
	 *
	 * @return Associative array list of taxonomies supported by current post.
	 */
...
function process_media( $url, $post_id ) {
	 ...
	 * @param int $post_id Post ID.
	 *
	 * @return string The name of the processing media.
	 */
...
function dt_use_block_editor_for_post_type( $post_type ) {
	 ...
	 *
	 * @param bool   $use_block_editor  Whether the post type can be edited in the block editor. Default true.
	 * @param string $post_type         The post type being checked.
	 *
	 * @return bool Whether the post type can be edited in the block editor.
	 */
